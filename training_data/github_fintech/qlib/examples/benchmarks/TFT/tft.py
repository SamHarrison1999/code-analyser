...
from training_data.github_fintech.qlib.examples.benchmarks.TFT import libs, libs as utils
import training_data.github_fintech.qlib.examples.benchmarks.TFT.libs.tft_model
import os
...
# To register new training_data, please add them here.
ALLOW_DATASET = ["Alpha158", "Alpha360"]
# To register new training_data, please add their configurations here.
DATASET_SETTING = {
    "Alpha158": {
        "feature_col": [
            "RESI5",
...
class TFTModel(ModelFT):
    ...
    def fit(self, dataset: DatasetH, MODEL_FOLDER="qlib_tft_model", USE_GPU_ID=0, **kwargs):
        ...
        ExperimentConfig = training_data.github_fintech.qlib.examples.benchmarks.TFT.expt_settings.configs.ExperimentConfig
        ...
        # ===========================Training Process===========================
        ModelClass = training_data.github_fintech.qlib.examples.benchmarks.TFT.libs.tft_model.TemporalFusionTransformer
        if not isinstance(self.data_formatter, training_data.github_fintech.qlib.examples.benchmarks.TFT.data_formatters.base.GenericDataFormatter):
            raise ValueError(
