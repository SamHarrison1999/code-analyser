...
# ✅ Best Practice: Consider adding a docstring to the class to describe its purpose and usage.
...
class IndexBase:
    ...
    # ✅ Best Practice: Using a list to group related constants improves maintainability.
    ...
    def __init__(
        ...
        # ⚠️ SAST Risk (Low): Potential directory traversal if index_name is user-controlled
        """
    ...
    def bench_start_date(self) -> pd.Timestamp:
        ...
        -------
            index start date
        """
        # ✅ Best Practice: Use NotImplementedError to indicate that subclasses should implement this method
        raise NotImplementedError("rewrite bench_start_date")

    @property
    # ✅ Best Practice: Use @abc.abstractmethod to enforce implementation in subclasses
    @abc.abstractmethod
    ...
    @abc.abstractmethod
    # ✅ Best Practice: Using NotImplementedError to indicate an abstract method that should be implemented by subclasses
    ...
    # ✅ Best Practice: Docstring includes parameter and return type information, aiding in understanding the method's usage.
    ...
    @abc.abstractmethod
    # ⚠️ SAST Risk (Low): Potential NoneType dereference if get_new_companies() returns None
    ...
    def get_changes_with_history_companies(
        ...
        # ⚠️ SAST Risk (Low): Potential risk of concatenating an empty list if no changes are detected
        last_code = []
        # 🧠 ML Signal: Logging usage pattern
        result_df_list = []
        _columns = [
        ...
        # ✅ Best Practice: Using pd.concat for DataFrame concatenation is efficient and readable.
        return df
