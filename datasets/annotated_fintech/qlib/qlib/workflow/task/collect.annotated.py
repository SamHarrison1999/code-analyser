...
# ✅ Best Practice: Group imports from the same module together to improve readability.
...
class Collector(Serializable):
    ...
    # ⚠️ SAST Risk (Low): Using NotImplementedError without implementation can lead to runtime errors if not handled properly.
    ...
    def process_collect(collected_dict, process_list=[], *args, **kwargs) -> dict:
        ...
        """
        # 🧠 ML Signal: Usage of a method named `collect` suggests a data collection pattern.
        if not isinstance(process_list, list):
            # ✅ Best Practice: Class docstring provides a clear explanation of the class's purpose and usage.
            process_list = [process_list]
        # 🧠 ML Signal: Method chaining pattern with `process_collect` indicates a data processing workflow.
        result = {}
...
class MergeCollector(Collector):
    ...
    # 🧠 ML Signal: Using a function to transform keys
    """
...
# 🧠 ML Signal: Dynamic retrieval of experiment based on string input.
class RecorderCollector(Collector):
    ...
    def __init__(
        # ✅ Best Practice: Check if artifacts_key is None before assigning a default value
        # 🧠 ML Signal: Storing experiment object or callable for later use.
        self,
        experiment,
        # 🧠 ML Signal: Storing configuration for artifact paths.
        process_list=[],
        # ✅ Best Practice: Assigning function to an instance variable for later use
        rec_key_func=None,
        # ⚠️ SAST Risk (Low): Potential issue with mutable default arguments like lists or dictionaries.
        rec_filter_func=None,
        # ✅ Best Practice: Assigning a potentially modified artifacts_key to an instance variable
        artifacts_path={"pred": "pred.pkl"},
        artifacts_key=None,
        # ✅ Best Practice: Assigning function to an instance variable for later use
        list_kwargs={},
        # ✅ Best Practice: Assigning list_kwargs to an instance variable for later use
    ...
    def collect(self, artifacts_key=None, rec_filter_func=None, only_exist=True) -> dict:
        ...
        # 🧠 ML Signal: Method returning an attribute of an object
