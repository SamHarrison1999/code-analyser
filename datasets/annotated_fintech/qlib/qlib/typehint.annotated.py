...
# ✅ Best Practice: Conditional imports based on Python version ensure compatibility.
# ✅ Best Practice: Using typing_extensions for backward compatibility with older Python versions.
# ✅ Best Practice: Docstring provides clear examples and usage instructions for the class.
