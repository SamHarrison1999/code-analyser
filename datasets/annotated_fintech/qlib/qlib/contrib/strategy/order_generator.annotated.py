...
class OrderGenWInteract(OrderGenerator):
    ...
    def generate_order_list_from_target_weight_position(
        ...
        # 🧠 ML Signal: Calculation of reserved cash based on risk degree
        ...
        current_total_value = trade_exchange.calculate_amount_position_value(
            ...
            # ✅ Best Practice: Use of deepcopy to avoid modifying the original dictionary
        ...
        current_tradable_value = trade_exchange.calculate_amount_position_value(
            ...
            end_time=trade_end_time,
            only_tradable=True,
            # 🧠 ML Signal: Adjusting tradable value based on transaction costs
            # 🧠 ML Signal: Generating target amount position from weight position
        )
        # add cash
        ...
        # 🧠 ML Signal: Generating order list for target amount position
