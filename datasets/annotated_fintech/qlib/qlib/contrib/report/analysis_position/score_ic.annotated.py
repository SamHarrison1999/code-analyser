...
# 🧠 ML Signal: Function processes prediction labels to compute correlation scores
import pandas as pd
...
def _get_score_ic(pred_label: pd.DataFrame):
    ...
    :param pred_label:
    :return:
    # 🧠 ML Signal: Calculation of Pearson correlation for each datetime group
    """
    # 🧠 ML Signal: Calculation of Spearman rank correlation for each datetime group
    concat_data = pred_label.copy()
    # ✅ Best Practice: Returning results as a DataFrame for structured output
    # ✅ Best Practice: Provide a clear and concise docstring for the function, including parameter descriptions and return values.
