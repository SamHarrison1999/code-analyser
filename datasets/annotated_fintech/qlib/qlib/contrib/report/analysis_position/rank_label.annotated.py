...
def _get_figure_with_position(
    ...
    :return:
    """
    # ✅ Best Practice: Use of a dictionary to store results for efficient lookups
    _position_df = get_position_data(
        position,
        # ✅ Best Practice: Grouping data by a specific level for organized processing
        label_data,
        calculate_label_rank=True,
        start_date=start_date,
        end_date=end_date,
    )
    # ✅ Best Practice: Use of setdefault to initialize dictionary keys
    ...
    for _item in _pos_gp:
        ...
        # ⚠️ SAST Risk (Low): Potential IndexError if 'rank_label_mean' is not present
        # ✅ Best Practice: Conversion of dictionary to DataFrame for structured data manipulation
        # ✅ Best Practice: Formatting index for better readability
    ...
    # 🧠 ML Signal: Use of a generator to yield figures, indicating a pattern of streaming data
    ...
    for _col in _res_df.columns:
        yield ScatterGraph(
            ...
            layout=dict(
                title=_col,
                # ✅ Best Practice: Docstring provides a clear description of the function's purpose and usage.
