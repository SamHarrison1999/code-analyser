...
# ✅ Best Practice: Using a logger is a best practice for tracking and debugging application behavior.
...
class BaseExecutor:
    ...
    def __init__(
        ...
        # ✅ Best Practice: Docstring provides detailed parameter descriptions and examples
        verbose: bool = False,
        ...
        **kwargs: Any,
        ...
        # 🧠 ML Signal: Boolean flags for feature toggles
        """
        self.time_per_step = time_per_step
        self.indicator_config = indicator_config
        self.generate_portfolio_metrics = generate_portfolio_metrics
        # 🧠 ML Signal: Method call with parameters
        ...
        # ✅ Best Practice: Check if the object has an attribute before accessing it
        ...
        # 🧠 ML Signal: Method call pattern for resetting infrastructure
    ...
    def reset_common_infra(
        ...
        # 🧠 ML Signal: Method call pattern for resetting account with parameters
        ...
        if common_infra.has("trade_account"):
            ...
            # 🧠 ML Signal: Accessing a centralized resource, indicating a pattern of resource management
    ...
    @property
    # 🧠 ML Signal: Method delegation pattern, where a method calls another method on a different object
    ...
    def collect_data(
        ...
        # ⚠️ SAST Risk (Low): AssertionError risk if `yield_res` is not a tuple of length 2
        level: int = 0,
        ...
        self.trade_account.update_bar_end(
            ...
            # ⚠️ SAST Risk (Low): Using mutable default argument 'indicator_config' can lead to unexpected behavior
        ...
        # 🧠 ML Signal: Use of boolean flags to control behavior
        # ✅ Best Practice: Explicitly calling superclass constructor
        return res
...
class NestedExecutor(BaseExecutor):
    ...
    def __init__(
        ...
        # 🧠 ML Signal: Method chaining pattern for resetting infrastructure.
        start_time: Union[str, pd.Timestamp] = None,
        # 🧠 ML Signal: Method initializes trading with a decision, indicating a pattern of decision-based initialization.
        end_time: Union[str, pd.Timestamp] = None,
        # 🧠 ML Signal: Method chaining pattern for resetting infrastructure.
        indicator_config: dict = {},
        # ✅ Best Practice: Resetting executor with specific start and end times ensures clear state management.
        generate_portfolio_metrics: bool = False,
        verbose: bool = False,
        # 🧠 ML Signal: Fetching infrastructure level details, indicating a pattern of hierarchical infrastructure management.
        track_data: bool = False,
        skip_empty_decision: bool = True,
        # ✅ Best Practice: Setting sub-level infrastructure promotes modular and maintainable code.
        # ✅ Best Practice: Use of descriptive variable names improves code readability.
        align_range_limit: bool = True,
        common_infra: CommonInfrastructure | None = None,
        # 🧠 ML Signal: Resetting strategy with infrastructure and decision, indicating a pattern of strategy configuration.
        # ⚠️ SAST Risk (Low): Potential for NoneType error if `trade_decision.update` returns None unexpectedly.
        **kwargs: Any,
    ) -> None:
        """
        Parameters
        ...
        # ⚠️ SAST Risk (Low): Use of assert statement can be disabled with optimization flags, consider using explicit error handling
    ...
    def reset_common_infra(
        ...
        """
        # ✅ Best Practice: Include a docstring to describe the method's purpose
        # 🧠 ML Signal: Method calls another method on an object, indicating a pattern of delegation or composition
        ...
        # 🧠 ML Signal: Use of method calls on objects to retrieve data
        self.inner_strategy.reset_common_infra(common_infra)

    # ✅ Best Practice: Type hinting for list initialization improves code readability and maintainability
    def _init_sub_trading(self, trade_decision: BaseTradeDecision) -> None:
        ...
        # ⚠️ SAST Risk (Low): Use of assert for type checking can be bypassed; consider using explicit type checks
    ...
    def _collect_data(
        ...
        while not self.inner_executor.finished():
            ...
            # 🧠 ML Signal: The use of `trade_type` indicates a configuration or mode that could influence the behavior of the simulator, useful for ML models to understand different operational modes.
            ...
            if (
                ...
                # NOTE: !!!!!
                # 🧠 ML Signal: Usage of a helper function to retrieve orders based on a decision
                ...
                # 🧠 ML Signal: Sorting orders based on a specific attribute
                #   (inner Qlib Executor)])
                ...
                # below is proposed
                # 🧠 ML Signal: Method signature with specific parameter types and return type hints
                # - The entry script follow the example of  _RL learning example_ to be compatible with all kinds of
                # ✅ Best Practice: Explicit return of the iterator for clarity
                #   RL Framework
                ...
                # 🧠 ML Signal: Iterating over orders, indicating a pattern of processing multiple items
                ...
                # ✅ Best Practice: Using formatted strings for logging improves readability
