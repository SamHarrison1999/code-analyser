...
# ✅ Best Practice: Grouping standard library imports together
from __future__ import annotations

# ✅ Best Practice: Grouping third-party library imports together
...
# ✅ Best Practice: Using TYPE_CHECKING to avoid circular imports and improve performance

# ✅ Best Practice: Grouping third-party library imports together
# ✅ Best Practice: Type hints for function parameters and return type improve code readability and maintainability.
# ✅ Best Practice: Relative import for internal module
if TYPE_CHECKING:
...
# ✅ Best Practice: Type alias for readability and maintainability
...
def backtest_loop(
    ...
    # ✅ Best Practice: Initializing return_value as a dictionary to store results from the loop.
    trade_strategy: BaseStrategy,
    trade_executor: BaseExecutor,
    # 🧠 ML Signal: Iterating over a data collection loop, which may indicate a pattern of data processing.
...
def collect_data_loop(
    ...
    object
        trade decision
    """
    # ✅ Best Practice: Using `format` for string formatting is more readable and maintainable than concatenation.
    # ⚠️ SAST Risk (Low): Updating a mutable default argument can lead to unexpected behavior if reused.
