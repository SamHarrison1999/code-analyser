...
# ✅ Best Practice: Consider importing the enum module to ensure the code runs correctly.
...
class InputTypes(enum.IntEnum):
    ...
    # 🧠 ML Signal: Method signature suggests data splitting, a common ML preprocessing step
    ...
    # ✅ Best Practice: Using abc.abstractmethod decorator indicates that this method is intended to be overridden in subclasses.
...
class GenericDataFormatter(abc.ABC):
    ...
    def transform_inputs(self, df):
        # ⚠️ SAST Risk (Low): Method raises NotImplementedError, which can cause runtime errors if not overridden.
    ...
    @property
    @abc.abstractmethod
    # 🧠 ML Signal: Returns a tuple indicating the use of all available samples for calibration
    ...
    @abc.abstractmethod
    # 🧠 ML Signal: Pattern for checking the uniqueness of a specific input type in a list.
    ...
    # 🧠 ML Signal: List comprehension usage indicates a pattern of filtering and transforming data
    # ✅ Best Practice: Use of a helper function to improve code readability and reusability
    # Shared functions across data-formatters
    # ✅ Best Practice: Returning a concatenated list of filtered results.
    # ✅ Best Practice: List comprehension is used for concise and efficient iteration
    @property
    # ✅ Best Practice: List comprehension for concise and efficient iteration
    def num_classes_per_cat_input(self):
        ...
        """
        # 🧠 ML Signal: Identifying categorical inputs for potential feature engineering
    ...
    def get_num_samples_for_calibration(self):
        ...
        """
        # 🧠 ML Signal: Identifying real-valued inputs for potential feature engineering
        # ✅ Best Practice: Use of a dictionary to organize related configuration data
        # 🧠 ML Signal: Tracking input size for model input layer configuration
        return -1, -1

    # 🧠 ML Signal: Tracking output size for model output layer configuration
    def get_column_definition(self):
        # 🧠 ML Signal: Tracking category counts for categorical feature encoding
        # 🧠 ML Signal: Identifying target input locations for supervised learning
        ...
        def _check_single_column(input_type):
            # 🧠 ML Signal: Identifying known regular inputs for time series forecasting
            # 🧠 ML Signal: Checking for required keys in parameters is a common pattern in ML experiments
            # 🧠 ML Signal: Identifying static input locations for model input configuration
        ...
        # 🧠 ML Signal: Use of column definitions is common in data preprocessing for ML models
        # 🧠 ML Signal: Updating parameters with input indices is a pattern in ML model setup
