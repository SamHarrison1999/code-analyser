...
# ⚠️ SAST Risk (Low): Hardcoded URLs can lead to security risks if they change or if sensitive data is exposed.
CZCE_DAILY_URL = (
    "http://www.czce.com.cn/portal/DFSStaticFiles/Future/%s/%s/FutureDataDaily.txt"
)
CZCE_OPTION_URL = (
    "http://www.czce.com.cn/portal/DFSStaticFiles/Option/%s/%s/OptionDataDaily.txt"
)
# ⚠️ SAST Risk (Low): Hardcoded URLs can lead to security risks if they change or if sensitive data is exposed.
CFFEX_COLUMNS = [
    "open",
