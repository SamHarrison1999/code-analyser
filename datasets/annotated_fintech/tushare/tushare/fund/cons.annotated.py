...
NAV_OPEN_API = {
    "all": "getNetValueOpen",
    "equity": "getNetValueOpen",
    "mix": "getNetValueOpen",
    "bond": "getNetValueOpen",
    "monetary": "getNetValueMoney",
    "qdii": "getNetValueOpen",
}

NAV_OPEN_KEY = {
    "all": "6XxbX6h4CED0ATvW",
    "equity": "Gb3sH5uawH5WCUZ9",
    "mix": "6XxbX6h4CED0ATvW",
    "bond": "Gb3sH5uawH5WCUZ9",
    "monetary": "uGo5qniFnmT5eQjp",
    "qdii": "pTYExKwRmqrSaP0P",
}
NAV_OPEN_T2 = {
    "all": "0",
    "equity": "2",
...
NAV_COLUMNS = {
    "open": NAV_OPEN_COLUMNS,
    "close": NAV_CLOSE_COLUMNS,
    "grading": NAV_GRADING_COLUMNS,
}
...
SINA_FUND_INFO_URL = (
    "%s%s/fundInfo/api/openapi.php/FundPageInfoService.tabjjgk?symbol=%s&format=json"
)
...
# ✅ Best Practice: Function name starts with an underscore, indicating it's intended for internal use.
OFT_MSG = "开放型基金类型输入有误，请输入all、equity、mix、bond、monetary、qdii"
