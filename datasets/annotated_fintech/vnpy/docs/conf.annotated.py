...
# ✅ Best Practice: Use a consistent naming convention for paths
...
latex_documents = [
    (master_doc, "vnpy.tex", "vnpy Documentation", "VeighNa Team", "manual"),
]
...
man_pages = [(master_doc, "vnpy", "vnpy Documentation", [author], 1)]
