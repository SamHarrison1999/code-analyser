...
def test_000001_finance_factor():
    correct_timestamps = [
        ...
        "1994-06-30",
        "1993-12-31",
        # 🧠 ML Signal: Querying data from a database with specific parameters
        "1993-06-30",
        "1992-12-31",
        "1991-12-31",
        "1990-12-31",
    ...
    result = FinanceFactor.query_data(
        ...
        return_type="domain",
        codes=["000001"],
        # ✅ Best Practice: Asserting the length of results to ensure data integrity
        end_timestamp="2018-12-30",
        order=FinanceFactor.report_date.desc(),
        # 🧠 ML Signal: Conversion of date objects to string format
        time_field="report_date",
    )
    # ✅ Best Practice: Using set comparison to ensure all timestamps match
    assert len(correct_timestamps) == len(result)
    timestamps = [to_time_str(item.report_date) for item in result]
    # 🧠 ML Signal: Accessing the first element of a result set
    assert set(correct_timestamps) == set(timestamps)
    latest: FinanceFactor = result[0]
    # ✅ Best Practice: Asserting specific financial metrics for validation
    ...
    # 🧠 ML Signal: Hardcoded list of timestamps could indicate a pattern for expected data ranges
...
def test_000001_balance_sheet():
    correct_timestamps = [
        ...
        "1998-06-30",
        "1997-12-31",
        # 🧠 ML Signal: Querying data with specific parameters can indicate common usage patterns
        "1997-06-30",
        "1996-12-31",
        "1996-06-30",
        "1995-12-31",
        ...
        "1991-12-31",
        "1990-12-31",
        # ✅ Best Practice: Asserting the length of results ensures data consistency
        "1989-12-31",
    ]
    # 🧠 ML Signal: Converting dates to strings is a common pattern for date handling
    result = BalanceSheet.query_data(
        session=session,
        # ✅ Best Practice: Using set comparison for lists ensures order does not affect equality
        provider="eastmoney",
        return_type="domain",
    ...
    # 🧠 ML Signal: Hardcoded timestamps could indicate a pattern in data retrieval or testing.
...
def test_000001_income_statement():
    correct_timestamps = [
        ...
        "2001-06-30",
        "2001-03-31",
        # 🧠 ML Signal: Querying data with specific parameters can indicate typical usage patterns.
        # ⚠️ SAST Risk (Low): Ensure that the session object is properly managed to prevent resource leaks.
        "2000-12-31",
        "2000-06-30",
        "1999-12-31",
        "1999-06-30",
        ...
        "1994-12-31",
        "1994-06-30",
        # 🧠 ML Signal: Conversion of dates to strings could be a common data processing step.
        "1993-12-31",
        "1993-06-30",
        # ✅ Best Practice: Using set comparison for lists ensures order-agnostic equality.
        "1992-12-31",
        "1991-12-31",
...
def test_000001_cash_flow_statement():
    correct_timestamps = [
        ...
        "2007-09-30",
        "2007-06-30",
        # 🧠 ML Signal: Querying data with specific parameters can indicate usage patterns.
        "2007-03-31",
        "2006-12-31",
        "2006-09-30",
        "2006-06-30",
        ...
        "2004-06-30",
        "2004-03-31",
        # 🧠 ML Signal: Converting and comparing timestamps can indicate data validation patterns.
        "2003-12-31",
        "2003-09-30",
        # ✅ Best Practice: Using set comparison for timestamps ensures order-agnostic validation.
        "2003-06-30",
        "2003-03-31",
        # ✅ Best Practice: Type hinting improves code readability and maintainability.
        "2002-12-31",
        "2002-06-30",
        # 🧠 ML Signal: Asserting specific financial values can indicate expected data patterns.
        "2001-12-31",
        "2001-06-30",
        "2000-12-31",
        "2000-06-30",
    ...
    # 🧠 ML Signal: Hardcoded list of timestamps, useful for pattern recognition in test data
...
def test_000778_finance_factor():
    correct_timestamps = [
        ...
        "2007-09-30",
        "2007-06-30",
        # 🧠 ML Signal: Querying data with specific parameters, useful for learning query patterns
        "2007-03-31",
        "2006-12-31",
        "2006-09-30",
        "2006-06-30",
        ...
        "2004-09-30",
        "2004-06-30",
        # ✅ Best Practice: Using list comprehension for concise and readable code
        "2004-03-31",
        "2003-12-31",
        "2003-09-30",
        "2003-06-30",
        # 🧠 ML Signal: Asserting specific financial metrics, useful for learning expected values
        "2003-03-31",
        "2002-12-31",
        "2002-09-30",
        "2002-06-30",
...
def test_000778_balance_sheet():
    correct_timestamps = [
        ...
        "2006-03-31",
        "2005-12-31",
        # ✅ Best Practice: Using set comparison for unordered data validation
        "2005-09-30",
        "2005-06-30",
        # 🧠 ML Signal: Accessing the first element of a result set
        "2005-03-31",
        "2004-12-31",
        # ✅ Best Practice: Asserting specific fields to validate data correctness
        "2004-09-30",
        "2004-06-30",
        "2004-03-31",
        "2003-12-31",
...
def test_000778_income_statement():
    correct_timestamps = [
        ...
        "2011-12-31",
        "2011-09-30",
        # 🧠 ML Signal: Usage of a specific query pattern with parameters
        ...
        "2008-03-31",
        "2007-12-31",
        # ✅ Best Practice: Use of set for comparison to ensure order does not matter
        "2007-09-30",
        "2007-06-30",
        # ✅ Best Practice: Type hinting for better code readability and maintainability
        "2007-03-31",
        "2006-12-31",
        # ✅ Best Practice: Use of assertions to validate expected values
        "2006-09-30",
        "2006-06-30",
        "2006-03-31",
        "2005-12-31",
...
def test_000778_cash_flow_statement():
    correct_timestamps = [
        ...
        "2015-12-31",
        "2015-09-30",
        # 🧠 ML Signal: Querying data with specific parameters, useful for understanding data retrieval patterns
        "2015-06-30",
        "2015-03-31",
        "2014-12-31",
        "2014-09-30",
        ...
        "2011-12-31",
        "2011-09-30",
        # 🧠 ML Signal: Asserting specific values, useful for learning expected outcomes in test cases
        "2011-06-30",
        "2011-03-31",
        "2010-12-31",
        "2010-09-30",
