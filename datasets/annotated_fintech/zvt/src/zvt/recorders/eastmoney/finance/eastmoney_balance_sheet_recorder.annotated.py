...
# 🧠 ML Signal: Mapping of financial terms to standardized keys, useful for feature extraction in ML models
...
balance_sheet_map = {
    ...
    # ✅ Best Practice: Adding new keys to the dictionary with transformations for specific use cases
    # 🧠 ML Signal: Class definition for a specific financial data recorder
    # 股东权益合计
    "total_equity": "Sumshequity",
    # 🧠 ML Signal: URL pattern for accessing financial data
    # 负债和股东权益合计
    "total_liabilities_and_equity": "Sumliabshequity",
    # 🧠 ML Signal: Specific type of financial report being recorded
    # 银行相关
    # 资产
    # 🧠 ML Signal: Data type identifier for the financial data
