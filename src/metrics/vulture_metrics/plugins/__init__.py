# File: code_analyser/src/metrics/vulture_metrics/plugins/__init__.py

"""
Vulture Metric Plugin Loader

Dynamically discovers and loads VultureMetricPlugin subclasses from this directory.
...
from .base import VultureMetricPlugin as BasePlugin
...
# 🧠 ML Signal: Registry defines Vulture-derived metrics for supervised learning
...
VultureMetricPlugin = BasePlugin


def load_plugins() -> list[BasePlugin]:
    """Instantiate and return all discovered Vulture metric plugins."""
